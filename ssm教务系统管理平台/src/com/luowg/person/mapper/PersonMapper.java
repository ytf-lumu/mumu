package com.luowg.person.mapper;
...
public interface PersonMapper {
	public Long findCount(Person p) throws Exception;
	public List<Person> findDataTables(Map<String,Object> m) throws Exception;
	public Person getById(String id) throws Exception;
	public void save(Person p) throws Exception;	
	public List<Text> selectNode() throws Exception;
