...
$.extend(true, $.fn.dataTable.defaults, {
  //  "dom": "<'row'<'col-md-6 col-sm-6'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-5'i><'col-md-6 col-sm-6'p><'col-md-1 col-sm-1'l>>", // default layout with horizobtal scrollable datatable
    "dom": "<'table-scrollable't><'row'<'col-md-5 col-sm-5'i><'col-md-6 col-sm-6'p><'col-md-1 col-sm-1'l>>", // default layout with horizobtal scrollable datatable
    "language": {
        "emptyTable": "没有数据",
        //"info": "Showing _START_ to _END_ of _TOTAL_ records",<span class="label bg-red-sunglo">Label </span>
        "info": "共有记录：_TOTAL_条，显示第_START_到_END_条",
        "infoEmpty": "没有查询到相关记录，请重新设置条件",
        "infoFiltered": "",
        "lengthMenu": "_MENU_",
        "search": "快速过滤:",
        "zeroRecords": "没有查询到数据",
