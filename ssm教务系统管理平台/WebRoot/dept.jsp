...
<div class="page-content clearfix">
    ...
    <div class="title_names" style="margin-top: 10px;">搜索查询</div>
      <ul class="search_content clearfix" style="margin-top: 10px;">
       <li><label class="l_f">部门名称</label><input name="dept1" id="dept1" type="text"  class="text_add" placeholder="输入部门名称"  style=" width:200px"/></li>
       <li><label class="l_f">部门电话</label><input name="phone1" id="phone1" type="text"  class="text_add" placeholder="输入部门电话"  style=" width:200px"/></li>
       <!-- <li><label class="l_f">开始时间</label><input name="" type="text"  class="text_add" id="start" placeholder="选择时间"/></li>
       <li><label class="l_f">结束时间</label><input name="" type="text"  class="text_add" id="start" placeholder="选择时间"/></li>
        -->
   ...
   <div class="add_menber" id="add_menber_style" style="display:none">
    ...
    <ul class=" page-content">
     <li><label class="label_name">序号：</label><span class="add_name"><input value="" id="id" name="id" type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>    
     <li><label class="label_name">部门名称：</label><span class="add_name"><input id="deptname" name="deptname"   type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>
     <li><label class="label_name">类别：</label><span class="add_name"><input id="category" name="category"   type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>
     <li><label class="label_name">部门负责人：</label><span class="add_name">   <input id="head" name="head" type="text"  class="text_add" style=" width:250px"/></span><div class="prompt r_f"></div></li>
     <li><label class="label_name">部门电话：</label><span class="add_name"><input id="phone" name="phone" type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>       
    </ul>
    </form>
 </div>
