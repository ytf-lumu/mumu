				...
				<div class="col-md-4 col-sm-12 login-box">
					<form class="form-horizontal">
						...
						<div class="input-group margin-top-10">
							...
							<input type="text" class="form-control" placeholder="密码" id="password" name="loginPass">
								...
								<!-- <div class="col-xs-6 col-sm-6 col-md-6">
									<div class="input-group">
										<span class="input-group-addon"><span class="glyphicon glyphicon-th-large"></span></span>
										 ...
										 <input maxlength="4" type="text" autocomplete="off" class="form-control" placeholder="验证码" id="code" name="验证码"/>	
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									
									<a class="btn btn-link" id="re-code" href="javascript:void(0)" onfocus="blur()" style="text-decoration:none"><img src="img.shtml" class="img-responsive pull-left"/>
									 &nbsp;&nbsp;换一张&nbsp;&nbsp;</a> 
								</div> -->
						</div>
