...
<div class="page-content clearfix">
    ...
    <div class="title_names" style="margin-top: 10px;">搜索查询</div>
      <ul class="search_content clearfix" style="margin-top: 10px;">
       <li><label class="l_f">会员名称</label><input name="uname" id="uname" type="text"  class="text_add" placeholder="输入会员名称、电话、邮箱"  style=" width:200px"/></li>
       <li><label class="l_f">开始时间</label><input name="startTime" type="text" value=""  class="text_add" id="startTime" placeholder="选择时间"/></li>
       <li><label class="l_f">结束时间</label><input name="endTime" type="text" value="" class="text_add" id="endTime" placeholder="选择时间"/></li>
...
<div class="add_menber" id="add_menber_style" style="display:none">
    ...
    <ul class=" page-content">
     <li><label class="label_name">姓名：</label><span class="add_name"><input value="" id="username" name="username" type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>
     <li><label class="label_name">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</label><span class="add_name" >
     <label><input name="sex" id="nan" 	  value="0"  type="radio" checked="checked" 	class="ace"><span class="lbl">男</span></label>&nbsp;&nbsp;&nbsp;
     ...
     <li><label class="label_name">移动电话：</label><span class="add_name"><input id="phone" name="phone"   type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>
     ...
     <li><label class="label_name">住址：</label><span class="add_name">   <input id="adress" name="adress" type="text"  class="text_add" style=" width:250px"/></span><div class="prompt r_f"></div></li>
     ...
     <label><input name="status" type="radio" value="0" checked="checked" class="ace"><span class="lbl">开启</span></label>&nbsp;&nbsp;&nbsp;
     <label><input name="status" type="radio" value="1" class="ace"><span class="lbl">关闭</span></label></span><div class="prompt r_f"></div></li>
     <li>
     	<label class="label_name">等级：</label>
     	<span class="add_name">
     	<select name="level" id="level" style="margin-left: 11px;">
     		<option value="a">铁牌会员</option>
     		<option value="b">铜牌会员</option>
...
jQuery(function($) {
			...
			"columns" :[{
				...
				"orderable": false,
			  	"render": function ( data, type, rowObject, meta ) {
			  		var n = "";//JSON.stringify(rowObject)
		...
		function tooltip_placement(context, source) {
		 ...
		 $("#btn_search").on('click', function(){
			 /* $.ajax({
      		   type: "POST",
      		   url:  "${pageContext.request.contextPath}/person/getPersons",
      		   data:{username:$("#uname").val(),startTime:$("#startTime").val(),endTime:$("#endTime").val()}  
...
function member_edit(obj){
	...
	$("#add_menber_style input[name=sex]").val([obj.sex]);
	$("#add_menber_style input[name=status]").val([obj.status]);
	$("#add_menber_style select").val([obj.level]);
	...
	layer.confirm('确认要删除吗？',function(index){
		...
		//$(obj).parents("tr").remove();
			  $.ajax({
       		   ...
       		   data: {id:obj.id}, //$("#form").serialize() ,
       		
       		   success: function(msg){
       			   if(msg.success==true){
       				layer.msg('已删除!',{icon:1,time:1000});
       				$(ii).parents("tr").remove();
       			   }else{
