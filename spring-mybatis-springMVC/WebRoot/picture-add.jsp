   ...
   <div class="type_title">添加商品</div>
	<form action="" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		...
		<div class=" clearfix cl">
	     ...
	     <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="brief" name="brief"></div>
		</div>
		<div class=" clearfix cl">
			...
			<div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="region" name="region"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">材&nbsp;&nbsp;&nbsp;&nbsp;质：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="texture" name="texture"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">品&nbsp;&nbsp;&nbsp;&nbsp;牌：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="brandname" name="brandname"></div>
			</div>
             <div class="Add_p_s">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="nowprice" name="nowprice" >元</div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">原价格：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="costprice" name="costprice" >元</div>
			</div>
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-10">
				<textarea name="content_z" id="content_z" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
		...
		<div class="clearfix cl">
			<div class="Button_operation">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="button" id="p_button" name="p_button"><i class="icon-save "></i>保存并提交审核</button>
        ...
        function addFile( file ) {
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    } else {//lib/webuploader/0.1.5/server/preview.php
                        $.ajax('upload.php', {
                            method: 'POST',
                            data: '',
                            dataType:'json'
