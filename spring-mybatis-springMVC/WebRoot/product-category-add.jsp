...
<div class="type_style">
 <div class="type_title">产品类型信息</div>
  ...
  <form action="" method="post" class="form form-horizontal" id="formadd">
    ...
    <div class="formControls">
    <textarea name="note" id="note" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,100)"></textarea>
     <p class="textarea-numberbar"><em class="textarea-length">0</em>/100</p>
    </div>
    </div>
    <div class="">
     <div class="" style=" text-align:center">
      <input class="btn btn-primary radius" id="c_button" name="c_button" type="button" value="提交">
      </div>
    </div>
  </form>
  </div>
