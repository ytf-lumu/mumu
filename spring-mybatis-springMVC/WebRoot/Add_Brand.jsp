...
background-image: url(images/xtbg.png); 
...
<body>
<!-- enctype属性,两个值：
		1、multipart/form-data 不对字符编码。在使用包含文件上传控件的表单时，必须使用该值。
 		2、application/x-www-form-urlencoded 默认，在发送前编码所有字符
 		 action="${pageContext.request.contextPath}/brand/save" method="post" enctype="multipart/form-data"
 -->
<form  id="form" action="${pageContext.request.contextPath}/brand/save" method="post" enctype="multipart/form-data">
<div class=" clearfix">
 ...
 <div class="left_add">
   ...
   <ul class="add_conent">
    ...
    <li class=" clearfix"><label class="label_name"><i>*</i>品牌序号：</label> <input name="sorting" type="text" class="add_text" style="width:80px"/></li>
    <li class=" clearfix"><label class="label_name">品牌图片：</label>  
    <input type="file" name="file" id="file" />          

    </li>
         <li class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label> <input name="region" id="region" type="text" class="add_text" style="width:120px"/></li>
         <li class=" clearfix"><label class="label_name">品牌描述：</label> <textarea name="details" id="details" cols="" rows="" class="textarea" onkeyup="checkLength(this);"></textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">500</span>字</span></li>
         <li class=" clearfix"><label class="label_name"><i>*</i>显示状态：</label> 
         <label><input name="status" id="status" type="radio" class="ace" checked="checked"><span class="lbl">显示</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <label><input type="radio" class="ace" name="status" id="status"><span class="lbl">不显示</span></label>
         </li>
   </ul>
 </div>
 <div class="right_add">
  ...
  <div class="button_brand"><input name="save" id="save" type="submit"  class="btn btn-warning" value="保存"/><input name="off" id="off" type="reset" value="取消" class="btn btn-warning"/></div>
</div>
</form>
</body>
</html>
...
$(document).ready(function() {
	...
	var settings = {
		...
		upload_url: "${pageContext.request.contextPath}/upload.php",// 接受上传的地址
