 ...
 <div id="products_style">
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
       <li><label class="l_f">产品名称</label><input name="pname" id="pname" type="text"  class="text_add" placeholder="输入品牌名称"  style=" width:250px"/></li>      
       <li><label class="l_f">开始时间</label><input class="inline laydate-icon" id="startTime" name="startTime" style=" margin-left:5px;"></li>
       <li><label class="l_f">结束时间</label><input class="inline laydate-icon" id="endTime" name="endTime" style=" margin-left:5px;"></li>
...
jQuery(function($) {
		...
		"columns" :[{
			...
			"render": function ( data, type, rowObject, meta ) {
				var n = "";
				/* n="<a onclick=\"member_stop(this,'10001')\" href='javascript:;' title='停用' class='btn btn-xs btn-success'><i class='icon-ok bigger-120></i></a>'" */
				  n="<a title=\"编辑\" onclick=\"member_edit(\"编辑\",\"picture-add.jsp\",'4','','510')\" href=\"javascript:;\" class=\"btn btn=xs btn-info\" ><i class=\"icon-edit bigger-120\"></i></a>"
				  +"<a title=\"删除\" onclick='member_del(this,"+JSON.stringify(rowObject)+")' href=\"javascript:;\" class=\"btn btn=xs btn-warning\" ><i class=\"icon-trash bigger-120\"></i></a>";
				return n;
			}
			//<a onClick="member_stop(this,'10001')"  href="javascript:;" title="停用"  class="btn btn-xs btn-success"><i class="icon-ok bigger-120"></i></a> 
	       // <a title="编辑" onclick="member_edit('编辑','member-add.jsp','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
		...
		"ajax" : {
			"type" : 'POST',
			"url" : "${pageContext.request.contextPath}/product/getProducts",
			"data" : function(d) {
				d.cateid=tree;
		...
		//alert( 'Data source: '+oTable1.ajax.url() );			
...
var setting = {
	view: {
		dblClickExpand: false,//双击节点时，是否自动展开父节点的标识默认值: true	
	...
	async: {
		enable: true,
		url: "${pageContext.request.contextPath}/category/getCate",
		autoParam: ["id"],//作为参数提交的属性名称
		dataType: "text",
	},
	callback: {
...
$(document).ready(function(){
	...
	var zTree = $.fn.zTree.getZTreeObj("tree");//根据 treeId 获取 zTree 对象的方法
